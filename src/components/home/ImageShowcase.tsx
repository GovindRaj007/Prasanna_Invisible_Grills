...
const showcaseImages = [
  ...
  { src: promoSlide, alt: "Prasanna Invisible Grills - Premium Safety Solutions", label: "Our Services" },
];
...
export function ImageShowcase() {
  ...
  return (
    <section className="section-bg-1 relative overflow-hidden py-10 md:py-16">
